## Structure of the _BasicMinimalC++_ example

### Without the full structure of the application pages

```sh
🗂️ BasicMinimalC++                          # Current example
├── README.md                               # Current file that introduces and explains a project
│
└── 🗂️ src                                  # Source code
    ├── 🗂️ BasicMinimalC++                  # Directory with the name of the current Python package
    │   ├── main.qml                        # Root QML component        
    │   ├── main.cpp                        # Root C++ file      
    │   │
    ...
    │
    ├── BasicMinimalC++.qmlproject          # QML project for the Qt Creator IDE
    └── BasicMinimalC++.pro                 # C++ project for the Qt Creator IDE
