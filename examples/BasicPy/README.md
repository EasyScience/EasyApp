## Structure of the _BasicPy_ example

### Without the full structure of the application pages

```sh
🗂️ BasicPy                                  # Current example
├── README.md                               # Current file that introduces and explains a project
│
└── 🗂️ src                                  # Source code
    ├── 🗂️ BasicPy                          # Directory with the name of the current Python package
    ...
    │
    ├── BasicPy.qmlproject                  # QML project for the Qt Creator IDE
    └── BasicPy.pyproject                   # Python project for the Qt Creator IDE
